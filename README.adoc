...
* *Snippet Manager*: Create, search, favorite, and organize reusable snippets with Monaco-powered syntax highlighting, line numbers, save-edited-as-new support, one-liner export, optional one-liner script arguments, JSON/XML/YAML import/export, plain-text script export, and ZIP script archives with optional password or GPG encryption
