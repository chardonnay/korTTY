...
* *Flow diagram* — an auto-generated diagram of the script logic with the full toolbar (zoom, fit, save SVG/PNG, copy image/PlantUML, background colour, regenerate) that highlights the matching source lines when you hover a node
