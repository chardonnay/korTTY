...
*v2.1.0* — A modern SSH client with JavaFX interface, tabbed terminals, SFTP tooling, background job scheduling, and OpenAI-compatible AI assistance.
...
The MOTHER effect is built as an exportable bundled plugin JAR and can be used as the in-repository reference implementation:
