...
*v2.2.1* | link:../README.adoc[Back to README]
...
| macOS (.dmg) | `./gradlew jpackageDmg` | `build/jpackage/korTTY-2.2.1.dmg`
| Windows (.exe) | `gradlew.bat jpackage` | `build\jpackage\korTTY\`
| Windows (.msi) | `gradlew.bat jpackageMsi` | `build\jpackage\korTTY-2.2.1.msi`
| Linux (AppImage) | `./gradlew jpackage` | `build/jpackage/korTTY/`
| Linux (.deb) | `./gradlew jpackageDeb` | `build/jpackage/korTTY-2.2.1.deb`
| Linux (.rpm) | `./gradlew jpackageRpm` | `build/jpackage/korTTY-2.2.1.rpm`
|===
