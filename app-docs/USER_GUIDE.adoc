...
*v2.2.2* | link:../README.adoc[Back to README]
...
| macOS (.dmg) | `./gradlew jpackageDmg` | `build/jpackage/korTTY-2.2.2.dmg`
| Windows (.exe) | `gradlew.bat jpackage` | `build\jpackage\korTTY\`
| Windows (.msi) | `gradlew.bat jpackageMsi` | `build\jpackage\korTTY-2.2.2.msi`
| Linux (AppImage) | `./gradlew jpackage` | `build/jpackage/korTTY/`
| Linux (.deb) | `./gradlew jpackageDeb` | `build/jpackage/korTTY-2.2.2.deb`
| Linux (.rpm) | `./gradlew jpackageRpm` | `build/jpackage/korTTY-2.2.2.rpm`
|===
