...
- **Live-Journal-Panel** (**Ansicht → Live-Journal**, ++ctrl+alt+l++) – eine andockbare Echtzeitansicht der Ausführung des aktiven Tabs [Sitzungsjournal](../features/session-journal.md#das-live-journal-panel); Seite und Breite werden beim nächsten Start wiederhergestellt.
