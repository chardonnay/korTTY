...
| Nur Terminalfenster | ++f12++ | Blenden Sie die Titelleiste, die Menüs, die Registerkartenleiste und die Statusleiste aus und zeigen Sie nur das Terminal an, wobei die vorherige Fenstergröße beibehalten und auf einem leeren Vollbildhintergrund zentriert wird |
