...
- **Sicherheit und Wiederherstellung:** KorTTY lehnt Frontmaterie, Anweisungen, Links, Rückrufe, externe Bilder/Symbole, übergroße Quellen und übermäßig komplexe Diagramme vor dem Rendern ab und validiert jedes generierte Diagramm anhand der eingeschränkten Grammatik seiner Familie mit Kompaktheitsbeschränkungen pro Familie (z. B. höchstens 12 Flussdiagramm-Aktions-/Entscheidungsknoten, 12 Sequenzteilnehmer, 12 Zustände, 12 Klassen oder 12 Entitäten). Ein abgelehntes Ergebnis der logischen Struktur eines gesamten Snippets greift ohne eine weitere KI-Anfrage auf das deterministische lokale Flussdiagramm zurück. Stattdessen wird der Fehler bei auswahlbezogenen und Nicht-Flussdiagramm-Generierungen gemeldet, und nichts, was kaputt ist, wird jemals gespeichert. Eine Antwort, die bei der Ausgabe-Token-Obergrenze abgeschnitten wurde, wird als solche und nicht als gewöhnlicher Fehler gemeldet, da die übliche Ursache darin besteht, dass ein Denkmodell sein gesamtes Budget für die Reasoning ausgibt – eine kleinere Auswahl oder ein Modell, das weniger argumentiert als hilft. Sichere eingeschränkte Diagramme, die von älteren korTTY-Versionen gespeichert wurden, bleiben auch dann renderbar, wenn sie vor diesen strengeren Generierungsqualitätsregeln erstellt wurden. Anfragen werden mit einem Timeout von 30 Sekunden serialisiert; Bei Abbruch oder Zeitüberschreitung wird der Renderer verworfen und die ausgeblendete WebView wird nach der Leerlaufzeit freigegeben.
