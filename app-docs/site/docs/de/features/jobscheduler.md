...
### Registerkarte „Job“: Ziele und Zeitpläne
...
| **Name** | Anzeigename, der in der Jobliste, im Journal und im Menüleistenstatus angezeigt wird. |
...
| **Tagebuch** | `LIMITED_REDACTED` speichert begrenzte, redigierte Auszüge. `FULL` speichert die vollständige Ausgabe/Transkripte (von KorTTY verwaltete Geheimnisse werden weiterhin geschwärzt). |
...
### Registerkarte „Aktion“: Jobtypen und Konfiguration
...
| **SFTP_DELETE** | Löschen Sie einen Remote-Pfad. |
...
| **SFTP_CHOWN** | Eigentümer und/oder Gruppe ändern. Besitzer- und Gruppenschaltflächen können das Ziel abfragen und verfügbare Werte anzeigen. |
...
- **Hochladen**: Lokale Quellverzeichnisse werden unter dem Remote-Zielstamm synchronisiert.
...
## Beenden von KorTTY während der Ausführung von Jobs
...
- Neue geplante oder manuelle Jobstarts werden blockiert;
