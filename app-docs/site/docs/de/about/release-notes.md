...
- **Eine Anfrage für Analyse und Diagramm** – wenn Sie **Vollständige Codeanalyse** öffnen oder auf **Erneut ausführen** klicken, wird jetzt eine kombinierte KI-Anfrage für den Bericht und sein anfängliches Mermaid-Flussdiagramm gesendet, anstatt das Snippet zweimal zu senden. Ein ungültiges oder fehlendes Mermaid-Ergebnis wird ohne versteckten Wiederholungsversuch lokal zurückgesetzt. **Regenerieren** bleibt eine explizite reine Diagrammanforderung und verwendet das aktive Analyseprofil.
