...
- **Vollständige portable Windows-Archive** – jede Windows-ZIP-Datei enthält jetzt das vollständige, eigenständige `jpackage`-Anwendungsimage mit seinem Launcher, seinen Bibliotheken und der gebündelten Laufzeit; Das Windows-on-ARM-Archiv veröffentlicht selbst keinen unbrauchbaren Launcher mehr.
...
- **Kleinere Downloads und Installationen** – die gebündelte Formatter-Runtime und die eingebettete Java-Runtime wurden gekürzt und komprimiert, das macOS-Disk-Image verwendet jetzt eine stärkere Komprimierung (LZMA) und der Offline-Anleitung liefert keine Entwickler-Sourcemaps oder ungenutzten Suchkomponenten mehr. Installationen schrumpfen um etwa 150 MB, Downloads um 25–40 %.
