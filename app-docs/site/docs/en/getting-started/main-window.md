...
- **Live journal panel** (**View → Live Journal**, ++ctrl+alt+l++) — a dockable real-time view of the active tab's running [session journal](../features/session-journal.md#the-live-journal-panel); side and width are restored on the next launch.
