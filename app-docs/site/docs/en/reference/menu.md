...
| Terminal-only Fullscreen | ++f12++ | Hide the title bar, menus, tab bar and status bar and show only the terminal, kept at its previous window size and centered on an empty fullscreen background |
