...
- **Action-bar icons** — every button in Local Models (install, setup assistant, import, configure, start, stop, remove, refresh, search, load more, download, pause/resume, cancel) now carries a matching glyph, consistent with the other AI Manager tabs.
