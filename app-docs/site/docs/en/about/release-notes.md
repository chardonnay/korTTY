...
- **Persistent AI Manager navigation** — a bold accent underline continues to mark the open section—Profiles, Local Models, Knowledge Stores, Local AI, Saved Chats, or Swarm Chats—after focus moves into a table, search field, or action button, so the current primary area remains identifiable.
