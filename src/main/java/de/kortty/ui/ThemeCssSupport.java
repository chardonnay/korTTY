...
final class ThemeCssSupport {
    ...
    static String buildCss(String backgroundColor, String foregroundColor) {
        ...
        return String.join("\n",
            ...
            ".menu-button { -fx-background-color: " + bgHover + "; -fx-background-radius: 3; -fx-padding: 0; }",
            ".menu-button:hover, .menu-button:showing { -fx-background-color: " + border + "; }",
            ".menu-button:pressed { -fx-background-color: " + bgAlt + "; }",
            ".menu-button .label { -fx-text-fill: " + fg + "; }",
            ".menu-button .arrow-button .arrow { -fx-background-color: " + fg + "; }",
    ...
    static String buildChatCss(ChatPalette palette) {
        ...
        return String.join("\n",
            ...
            ".ai-chat-markdown .ai-chat-prose { -fx-fill: " + fg + "; }",
            ".ai-chat-markdown .ai-chat-inline-code { -fx-fill: " + accent + "; }",
            ".ai-chat-markdown .ai-chat-text-selection { -fx-fill: " + accent + "; -fx-opacity: 0.35; }",
            ".ai-chat-reasoning .ai-chat-markdown .ai-chat-prose { -fx-fill: " + muted + "; }",
