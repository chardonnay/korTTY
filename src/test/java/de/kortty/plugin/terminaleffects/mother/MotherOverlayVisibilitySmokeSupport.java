...
/**
 * Verifies on the JavaFX thread that the container-bound MOTHER overlay releases its canvas
 * backing store while hidden (background tab) and rebinds when it becomes visible again. Called
 * by {@code de.kortty.ui.TerminalEffectPreviewSmoke}; lives in this package for access to the
 * package-private overlay API.
 */
public final class MotherOverlayVisibilitySmokeSupport {

    private MotherOverlayVisibilitySmokeSupport() {
    }
    ...
    public static void verifyHiddenOverlayReleasesBackingStore() {
        ...
        MotherCrtOverlay overlay = new MotherCrtOverlay();
