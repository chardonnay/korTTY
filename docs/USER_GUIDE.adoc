...
* The toolbar lets you copy the conversation, export it to PDF/Markdown/plain text, close the tab, cancel running requests, and change the font size.
